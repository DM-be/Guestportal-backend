...
import { PKCS11, CKF_RW_SESSION, CKF_SERIAL_SESSION, CKA_CLASS, CKO_DATA, CKA_LABEL, CKA_VALUE  } from "pkcs11js";
...
export class Pkcs11Service {
    ...
    constructor() {
        ...
        this.pkcs11.load("/usr/lib/x86_64-linux-gnu/libbeidpkcs11.so.0");
        this.pkcs11.C_Initialize();
        console.log(this.pkcs11)

        this.readObjects(this.openSession());
    }
    ...
    private readObjects(session: Buffer) {
        this.pkcs11.C_FindObjectsInit(session, [{ type: CKA_CLASS, value: CKO_DATA }]);
